...
def video(request):
    if request.method == "POST" or request.method == "OPTIONS":
        ...
        try:
            ...
            return HttpResponse("Failed by Tensorflow... Need to clear session.")

        if not emotion_list:
            os.remove(os.path.join(settings.MEDIA_ROOT, 'video/sample_image.jpg'))
            return HttpResponse("Cannot find face(s)...")
        ...
        return HttpResponse("You look {}...".format(emotion_list[0]))
